...
def create_config(username, password, host, db):
    # data = render_template("admin/start/config.html", username=username, password=password, host=host, db = db)
    data = render_template("admin/start/config_sqlite.html", username=username,password=password, host=host, db = db)

...
class BookCatalog(db.Model):
    ...
    markdown = db.deferred(db.Column(TEXT, default="", nullable=False))
    html = db.deferred(db.Column(TEXT, default="", nullable=False))
    publish_markdown = db.deferred(db.Column(TEXT, default='', nullable=False))
    publish_html = db.deferred(db.Column(TEXT, default='', nullable=False))
